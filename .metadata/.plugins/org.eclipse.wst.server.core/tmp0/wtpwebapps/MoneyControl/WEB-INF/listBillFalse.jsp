...
<div class="container-fluid">
	<div class="panel panel-default">
		...
		<div class="panel-heading">
			<span class="glyphicon glyphicon-folder-open"></span> &middot;Contas Não Pagas <b>
				</b> <span class="pull-right"><a href="listBillTrueServlet">Contas Pagas <span class="glyphicon glyphicon-paperclip"></span></a></span>
		</div>
		...
		<table class="table table-hover table-bordered">
			<thead>
				<tr>
					...
					<td class="text-center alert-info"><b>Marcar como paga</b></td>
				</tr>
			</thead>
			...
			<tbody>
				<c:if test="${empty list }">
					<tr class="success">
						<td colspan="5">Você não tem contas =D!</td>
					</tr>
				</c:if>
				...
				<c:forEach var="bill" items="${list }">
					<tr>
						...
						<td class="text-center"><a href="changeBillStatusServlet?idBill=${bill.idBill }"
						   class="btn btn-success btn-sm btn-oval"><span class="glyphicon glyphicon-send"></span>
						</a></td>
					</tr>
				</c:forEach>
			</tbody>
